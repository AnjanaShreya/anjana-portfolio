...
function MainPortfolio() {
  ...
  // Fetch toggles and section order from the database
  useEffect(() => {
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="h-1.5 w-full bg-neutral-900 rounded-full overflow-hidden border border-white/5 p-0.5">
                <motion.div
                  className="h-full bg-gradient-gold rounded-full shadow-[0_0_10px_rgba(255,20,147,0.8)]"
          ...
          >
            ...
            <Navbar activeSection={activeSection} toggles={toggles} sectionOrder={sectionOrder} />
            ...
            <main id="primary-portfolio-root">
              ...
              {sectionOrder.map((sectionId) => {
                switch (sectionId) {
                  ...
                  case "experience":
                    return toggles.experience ? <Services key="experience" /> : null;
                  case "skills":
                    return toggles.skills ? (
                      <section id="skills" key="skills" className="relative bg-primary-dark/50 py-16 md:py-24 border-t border-white/5 cursor-default">
                  ...
                  case "projects":
                    return toggles.projects ? <Process key="projects" /> : null;
                  case "education":
                    return toggles.education ? (
                      <section id="education" key="education" className="relative bg-primary-dark/50 py-16 md:py-24 border-t border-white/5 cursor-default">
                  ...
                  case "certifications":
                    return toggles.certifications ? <Insights key="certifications" /> : null;
                  case "achievements":
                    return toggles.achievements ? <BeyondCode key="achievements" /> : null;
                  case "game":
                    return <AsteroidDodger key="game" />;
                  case "contact":
