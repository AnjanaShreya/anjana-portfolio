          ...
          <div className="px-4 py-2 flex flex-wrap gap-2 justify-start border-t border-white/5 bg-black/20 z-10">
            {actionPrompts.map((prompt) => (
              <button
                ...
                className="text-[9px] font-sans text-neutral-400 hover:text-white border border-white/5 hover:border-[#ff1493]/30 bg-white/1 hover:bg-[#ff1493]/5 px-2.5 py-1.5 rounded-full transition-all duration-300 cursor-pointer"
              >
                {prompt}
              </button>
            ))}
