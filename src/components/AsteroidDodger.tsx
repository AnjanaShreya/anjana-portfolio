...
const PU_TYPES = [
  ...
  { label: 'Football', short: 'GOL', color: '#ff1493', desc: '+20 AMMO', effect: 'football' },
];
...
export default function AsteroidDodger() {
  ...
  const updateAmmoDOM = (currentAmmo: number) => {
    ...
    for (let i = 0; i < pips; i++) {
      ...
      pip.className = `w-1 h-2.5 rounded-[1px] ${i < filled ? "bg-[#ff1493]" : "bg-neutral-800"}`;
      ...
      container.innerHTML = `
        <svg width="14" height="14" viewBox="0 0 16 16">
          <polygon
            ...
            fill="${i < currentLives ? "#ff1493" : "#333"}"
          />
        </svg>
      `;
  ...
  const shoot = () => {
    ...
    emitP(playerRef.current.x, playerRef.current.y - 12, '#ff1493', 4);
  };
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="fixed top-8 left-1/2 -translate-x-1/2 z-50 px-6 py-3.5 bg-neutral-950/90 border border-[#ff1493]/30 rounded-2xl shadow-[0_0_35px_rgba(255,215,0,0.15)] backdrop-blur-xl flex items-center gap-3 pointer-events-none"
          >
        ...
        {!isPlaying ? (
          <div className="space-y-6 py-12 max-w-xl mx-auto">
            <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mx-auto shadow-2xl">
              <Gamepad2 className="text-[#ff4d94] w-8 h-8 animate-bounce" />
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 bg-[#ff4d94] hover:bg-[#e5c100] text-black font-bold px-8 py-4 rounded-2xl transition-all hover:scale-105 shadow-[0_0_30px_rgba(255, 77, 148,0.2)] active:scale-95 cursor-pointer"
            >
              🎮 Play a quick game
            </button>
          </div>
          ...
          >
            ...
            <div className="flex justify-between items-center bg-[#07070f] border-b border-[#1e1e30] px-4 md:px-6 py-3.5">
              <div className="text-center">
                ...
                <div ref={scoreSpanRef} className="text-sm md:text-base font-bold text-[#ff1493]">0</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div ref={killsSpanRef} className="text-sm md:text-base font-bold text-[#ff1493]">0</div>
              </div>
              <div className="text-center">
                <div className="text-[8px] uppercase tracking-wider text-neutral-500 font-bold mb-0.5">Best</div>
                <div ref={bestSpanRef} className="text-sm md:text-base font-bold text-[#ff1493]">0</div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              {gameState !== "playing" && (
                <div className="absolute inset-0 bg-black/95 backdrop-blur-md flex flex-col items-center justify-center p-6 z-20 text-center">
                  ...
                  {gameState === "idle" ? (
                    <>
                      <h4 className="text-sm md:text-base font-bold text-[#ff1493] tracking-[3px] uppercase mb-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl w-full text-left font-sans mb-6">
                        ...
                        <div className="border border-[#1e1e30] rounded-xl p-3 bg-[#0a0a14]/60">
                          ...
                          <div className="space-y-1 text-[10px] text-neutral-400">
                            ...
                            <div><span className="bg-[#ff1493]/10 border border-[#ff1493]/20 text-[#ff1493] text-[8px] font-bold px-1.5 py-0.5 rounded mr-1.5 font-mono">GOL</span> <span className="text-[#ff1493]">+20 Ammo</span></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <button
                        onClick={startGame}
                        className="bg-[#ff1493] hover:bg-[#e6c200] text-black font-bold font-mono text-xs px-8 py-3 rounded-xl uppercase tracking-widest cursor-pointer shadow-[0_0_20px_rgba(255,215,0,0.25)]"
                      >
                        LAUNCH MISSION
                      </button>
                    </>
                    ...
                    <>
                      ...
                      <div className="flex gap-8 justify-center items-center bg-[#0a0a14]/60 border border-[#1e1e30] rounded-xl px-8 py-4 mb-6">
                        <div className="text-center">
                          <div className="text-lg md:text-xl font-bold text-[#ff1493]">{score}</div>
                        ...
                        <div className="text-center border-x border-[#1e1e30] px-6">
                          <div className="text-lg md:text-xl font-bold text-[#ff1493]">{bestScore}</div>
                          <div className="text-[8px] text-neutral-500 uppercase tracking-widest font-mono">Best</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg md:text-xl font-bold text-[#ff1493]">{kills}</div>
                      ...
                      <div className="flex gap-4">
                        <button
                          onClick={startGame}
                          className="bg-[#ff1493] hover:bg-[#e6c200] text-black font-bold font-mono text-xs px-6 py-3 rounded-xl uppercase tracking-widest cursor-pointer shadow-[0_0_15px_rgba(255,215,0,0.15)]"
                        >
                          Play Again
                        </button>
                        <button
