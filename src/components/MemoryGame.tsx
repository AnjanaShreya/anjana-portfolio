...
export default function MemoryGame() {
  ...
  const triggerConfetti = () => {
    const colors = ["#ff1493", "#ff4d94", "#06B6D4", "#61DAFB", "#34D399", "#818CF8", "#F472B6"];
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="fixed top-24 left-1/2 -translate-x-1/2 z-[9999] px-6 py-3.5 bg-neutral-950/90 border border-[#ff1493]/30 rounded-2xl shadow-[0_0_30px_rgba(255,20,147,0.25)] backdrop-blur-xl flex items-center gap-3 pointer-events-none"
          >
      ...
      <div className="max-w-4xl mx-auto text-center px-4 pt-6">
        ...
        <div className="flex justify-center items-center gap-6 mb-5 text-neutral-400 font-mono text-[11px] uppercase bg-white/2 border border-white/5 rounded-xl px-5 py-2.5 max-w-xs mx-auto backdrop-blur-md">
          <div className="flex items-center gap-1.5">
            <Clock size={12} className="text-[#ff1493]" />
          ...
          <button 
            ...
            className="p-1 hover:text-[#ff1493] hover:rotate-180 transition-all duration-300 cursor-pointer"
            title="Reset Game"
          >
            <RefreshCw size={12} />
          </button>
            ...
            return (
              ...
              >
                ...
                >
                  {/* Face Down Back Side */}
                  <div
                    className="absolute inset-0 bg-neutral-900/40 border border-white/5 rounded-2xl flex items-center justify-center backdrop-blur-md shadow-inner group-hover:border-[#ff1493]/30 transition-colors"
                    style={{ backfaceVisibility: "hidden" }}
                  >
                    <div className="w-6 h-6 rounded-full border border-dashed border-[#ff1493]/20 flex items-center justify-center">
                      <div className="w-2 h-2 bg-[#ff1493] rounded-full opacity-60" />
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderColor: card.isMatched ? "#ff1493" : "rgba(255, 255, 255, 0.1)",
          ...
          {gameCompleted && (
            ...
            >
              ...
              <div className="max-w-md space-y-6 text-center z-40 relative">
                <div className="w-16 h-16 bg-[#ff1493]/10 border border-[#ff1493]/20 rounded-2xl flex items-center justify-center mx-auto shadow-[0_0_30px_rgba(255,215,0,0.1)]">
                  <CheckCircle size={32} className="text-[#ff1493]" />
                </div>
                ...
                <button
                  onClick={initializeGame}
                  className="bg-[#ff1493] text-black font-bold px-6 py-3 rounded-xl hover:bg-[#e5c100] transition-colors font-mono text-xs uppercase tracking-wider cursor-pointer"
                >
                  Play Again
                </button>
              </div>
