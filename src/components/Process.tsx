...
import { CheckCircle, ArrowUpRight, AlertCircle, Sparkles, Clock } from "lucide-react";
        ...
        {processSteps.length > 0 ? (
                              ...
                              {step.metrics.map((metric, mIdx) => {
                                ...
                                return (
                                  <div key={mIdx} className="bg-white/5 border border-white/5 rounded-lg p-2.5 flex flex-col justify-center text-left">
                                    <span className="text-[10px] font-syne font-black text-[#ff4d94] tracking-wider">{value}</span>
          ...
          <div className="flex flex-col items-center justify-center py-20 px-6 rounded-3xl border border-white/5 bg-neutral-900/20 backdrop-blur-md max-w-2xl mx-auto text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              {/* Spinning/pulsing sparkles/clock icon with accent styling */}
              <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-6 shadow-2xl relative">
                ...
                <Sparkles className="h-7 w-7 text-accent-pink animate-pulse relative z-10" />
              </div>
              ...
              <p className="text-neutral-400 text-sm sm:text-base font-light leading-relaxed max-w-md">
                I am currently designing and developing new projects. Check back shortly to see detailed breakdowns of my engineering creations!
              </p>

              <div className="mt-8 flex items-center gap-2 font-mono text-[9px] uppercase tracking-widest text-neutral-500 bg-white/5 px-4 py-2 rounded-full border border-white/5">
                <Clock className="h-3.5 w-3.5 text-accent-pink shrink-0 animate-spin-slow" />
                <span>Status: Actively Coding</span>
              </div>
            </div>
          </div>
        )}
