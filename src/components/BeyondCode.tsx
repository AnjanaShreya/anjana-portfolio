...
export default function BeyondCode() {
    ...
    return (
      <section className="bg-primary-dark py-20 border-t border-white/5 flex items-center justify-center min-h-[300px]">
        <div className="flex flex-col items-center gap-3">
          <Sparkles className="h-6 w-6 text-[#ff4d94] animate-pulse" />
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-radial from-[#ff4d94]/3 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="mt-24 text-center max-w-4xl mx-auto relative px-4">
          ...
          <div className="w-16 h-[2px] bg-linear-to-r from-transparent via-[#ff4d94]/55 to-transparent mx-auto mt-8" />
        </div>
