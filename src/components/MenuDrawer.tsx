...
export default function MenuDrawer({ isOpen, onClose, activeSection, toggles = { experience: true, projects: true }, sectionOrder }: MenuDrawerProps) {
  ...
  const baseMenuItems = [
    ...(toggles.experience !== false ? [{ name: "Experiences", target: "services", key: "experience" }] : []),
    ...(toggles.skills !== false ? [{ name: "Skills", target: "skills", key: "skills" }] : []),
    ...(toggles.projects !== false ? [{ name: "Projects", target: "projects", key: "projects" }] : []),
    { name: "Contact", target: "contact", key: "contact" }
  ];
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="grid-bg relative h-full w-full bg-primary-dark/95 text-white flex flex-col justify-between p-6 md:p-12 lg:p-20 overflow-hidden"
          >
